package hr.fer.zpr.lumen.database;
...
import static hr.fer.zpr.lumen.database.DBConstants.CATEGORIES_VALUE;
import static hr.fer.zpr.lumen.database.DBConstants.CATEGORY_WORDS_PAIRS_FILENAME;
import static hr.fer.zpr.lumen.database.DBConstants.CATEGORY_WORD_PAIRS_CATEGORY;
import static hr.fer.zpr.lumen.database.DBConstants.CATEGORY_WORD_PAIRS_TABLE_NAME;
import static hr.fer.zpr.lumen.database.DBConstants.CATEGORY_WORD_PAIRS_WORD;
import static hr.fer.zpr.lumen.database.DBConstants.DATABASE_NAME;
import static hr.fer.zpr.lumen.database.DBConstants.IMAGES_FILENAME;
import static hr.fer.zpr.lumen.database.DBConstants.IMAGES_ID;
import static hr.fer.zpr.lumen.database.DBConstants.IMAGES_PATH;
import static hr.fer.zpr.lumen.database.DBConstants.IMAGES_TABLE_NAME;
import static hr.fer.zpr.lumen.database.DBConstants.LETTERS_FILENAME;
import static hr.fer.zpr.lumen.database.DBConstants.LETTERS_ID;
import static hr.fer.zpr.lumen.database.DBConstants.LETTERS_TABLE_NAME;
import static hr.fer.zpr.lumen.database.DBConstants.LETTERS_VALUE;
import static hr.fer.zpr.lumen.database.DBConstants.LETTER_SOUND_FILENAME;
import static hr.fer.zpr.lumen.database.DBConstants.LETTER_SOUND_ID;
import static hr.fer.zpr.lumen.database.DBConstants.LETTER_SOUND_IDSOUND;
import static hr.fer.zpr.lumen.database.DBConstants.LETTER_SOUND_LANGUAGE;
import static hr.fer.zpr.lumen.database.DBConstants.LETTER_SOUND_LETTER;
import static hr.fer.zpr.lumen.database.DBConstants.LETTER_SOUND_TABLE_NAME;
import static hr.fer.zpr.lumen.database.DBConstants.PATH_TO_IMAGES;
import static hr.fer.zpr.lumen.database.DBConstants.PATH_TO_SOUND_WORD;
import static hr.fer.zpr.lumen.database.DBConstants.SOUND_FILENAME;
import static hr.fer.zpr.lumen.database.DBConstants.SOUND_ID;
import static hr.fer.zpr.lumen.database.DBConstants.SOUND_PATH;
import static hr.fer.zpr.lumen.database.DBConstants.SOUND_TABLE_NAME;
import static hr.fer.zpr.lumen.database.DBConstants.WORDS_FILENAME;
import static hr.fer.zpr.lumen.database.DBConstants.WORDS_ID;
